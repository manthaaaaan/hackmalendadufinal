...
const Button = React.forwardRef(({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
  ...
  // Hero variants already have padding/sizing defined in their base styles in this specific request.
  const isHero = variant === "hero" || variant === "heroSecondary";
  const sizeClass = isHero ? "" : buttonSizes[size];
